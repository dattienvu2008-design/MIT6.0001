...
def find_tree_height(tree):
    ...
    if tree.get_right_child() == None and tree.get_left_child() == None:
        ...
        if find_tree_height(tree.get_right_child()) > find_tree_height(tree.get_left_child()):
            return find_tree_height(tree.get_right_child()) + 1
        else:
            return find_tree_height(tree.get_left_child()) + 1
...
def is_heap(tree, compare_func):
    ...
    if tree.get_right_child() == None and tree.get_left_child() == None:
        ...
        return is_heap(tree.get_left_child(), compare_func) and (compare_func(tree.get_left_child().get_value(),tree.get_value())) and is_heap(tree.get_right_child(), compare_func) and (compare_func(tree.get_right_child().get_value(),tree.get_value()))
